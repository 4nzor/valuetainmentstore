!function (e, t, o, n) {
    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.sticky = function (i) {
        var s, r = e(this), l = r.selector || "", c = (new Date).getTime(), a = [], f = arguments[0],
            m = "string" == typeof f, u = [].slice.call(arguments, 1);
        return r.each(function () {
            var r, d, h, g, p,
                b = e.isPlainObject(i) ? e.extend(!0, {}, e.fn.sticky.settings, i) : e.extend({}, e.fn.sticky.settings),
                v = b.className, x = b.namespace, C = b.error, S = "." + x, y = "module-" + x, k = e(this), T = e(t),
                w = e(b.scrollContext), z = (k.selector || "", k.data(y)),
            ...
            p = {
                initialize: function () {
                    ...
                    "MutationObserver" in t && (h = new MutationObserver(p.event.documentChanged), g = new MutationObserver(p.event.changed), h.observe(o, {
                        childList: !0,
                        subtree: !0
                    }), g.observe(P, {childList: !0, subtree: !0}), g.observe(d[0], {
                        childList: !0,
                        subtree: !0
                    ...
                    direction: function (e) {
                        ...
                        e = e || w.scrollTop();
                        var t = p.cache.element, o = p.cache.scrollContext, n = p.get.scrollChange(e),
                            i = t.height - o.height + b.offset, s = p.get.currentElementScroll(), r = s + n;
                    ...
                    offset: function () {
                        ...
                        "HTML" === e || "body" == e ? p.determineContainer() : Math.abs(r.outerHeight() - p.cache.context.height) > b.jitter && (p.debug("Context has padding, specifying exact height for container", p.cache.context.height), r.css({height: p.cache.context.height}))
                    ...
                    var t = e || w.scrollTop(), o = p.cache, n = o.fits, i = o.element, s = o.scrollContext,
                        r = o.context, l = p.is.bottom() && b.pushing ? b.bottomOffset : b.offset,
                        e = {top: t + l, bottom: t + l + s.height},
                        c = (p.get.direction(e.top), n ? 0 : p.get.elementScroll(e.top)), a = !n, f = 0 !== i.height;
                    ...
                    log: function (e) {
                        var t, o, n;
                        b.performance && (t = (new Date).getTime(), n = c || t, o = t - n, c = t, a.push({
                            Name: e[0],
                        ...
                        var t = b.name + ":", o = 0;
                        c = !1, clearTimeout(p.performance.timer), e.each(a, function (e, t) {
                            o += t["Execution Time"]
                        }), t += " " + o + "ms", l && (t += " '" + l + "'"), (console.group !== n || console.table !== n) && a.length > 0 && (console.groupCollapsed(t), console.table ? console.table(a) : e.each(a, function (e, t) {
                    ...
                    })), e.isFunction(l) ? c = l.apply(i, o) : l !== n && (c = l), e.isArray(s) ? s.push(c) : s !== n ? s = [s, c] : c !== n && (s = c), l
                }
